...
export default function AmAreaChart({
  categories = [],
  series = [],
  height = 300,
  valuePrefix = '',
  ...
  useLayoutEffect(() => {
    ...
    const palette = ['#6366F1', '#10B981', '#F59E0B', '#EF4444', '#EC4899', '#3B82F6'];
  ...
  }, [categories, series, isDark, valuePrefix, valueSuffix, rotateXLabels]);
